    ...
    <div className="boxGeneral">
      ...
      <div className="boxLinks">
        <ul className="links">
          ...
          <li> <a className="button" href="https://spp.pc.pe.gov.br/#/controle" target="_blank" title="Sistema de Procedimentos Policiais"> SPP </a></li>
          <li> <a className="button" href="https://sei.pe.gov.br/sip/login.php?sigla_orgao_sistema=GOVPE&sigla_sistema=SEI" target="_blank" title="Sistema Eletrônico de Informações"> SEI </a></li>
          ...
          <li> <a className="button" href="https://plantaodigital.pc.pe.gov.br/#/controle" target="_blank" title=" Sistema de Controle de Plantões Digitais">  SCPD </a></li>
        </ul>
      </div>
    </div>
   );
