    ...
    <div className="boxOthers">
      ...
      <div className="boxLinks">
        <ul className="links">
            ...
            <li> <a className="button" href="https://diarias.pc.pe.gov.br/#/controle" target="_blank" title="Sistema de Controle de Diárias"> SCD </a></li>
            <li> <a className="button" href="https://www.sadspm.pe.gov.br/web" target="_blank" title="Sistema de Perícias Médicas"> SPM </a></li>
